...
\diagrama{classes_projeto}{Diagrama de classes de projeto}


\diagrama{vcp_adicionarmembrosp}{VCP para o caso de uso adicionar membros.}
\diagrama{vcp_criargrupop}{VCP para o caso de uso criar grupo}
\diagrama{vcp_editareventop}{VCP para o caso de uso editar evento.}
\diagrama{vcp_excluircategoriap}{VCP para o caso de uso excluir categoria.}
\diagrama{vcp_excluirgrupop}{VCP para o caso de uso excluir grupo.}
\diagrama{vcp_participareventop}{VCP para o caso de uso participar evento.}
\diagrama{vcp_postarp}{VCP para o caso de uso postar.}
\diagrama{vpc_divulgareventop}{VCP para o caso de uso divulgar evento.}
