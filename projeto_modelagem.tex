...
\textcolor{red}{
\begin{rnegocio}{Banimento do usuário de aplicativo}
Ao banir um usuário do aplicativo, todos os anúncios, estabelecimentos, participações em eventos e posts em grupos serão removidos e ele será tirado dos grupos em que participa.
\end{rnegocio}
}

	\section{Classes de domínio} \bigskip
	As classes de domínio do sistema foram feitas com base nos casos de uso e para suportar as regras de negócio. 
...
\section{Diagrama de classes de Projeto}
Passando a fase de analise, temos a agora a fase de projeto, com novos diagramas. O diagrama de classes de projeto mudou muito em relação ao anterior, principalmente pelo uso de classes parametrizadas e navegabilidade. Nesse diagrama foi corrigida a presença da classe estabelecimento e surgiram classes que tinham aparecido na primeira fase no projeto de modelagem - causado por falhas na interpretação.

\diagrama{classes_projeto}{\textcolor{red}{Diagrama de classes de projeto}}

\begin{center}
 \begin{tabular}{|p{0.5\linewidth}|}
  \hline
  	Trocada a associação entre agenda e evento para agenda e o conjunto participações.\\ 
  \hline
  	Atributos dos métodos das classes. \\
  \hline
	Retorno dos métodos das classes.\\
  \hline
	Suporte para os estados dos DTEs inclusos.\\
  \hline
	Suporte às operações dos diagramas de atividades.\\
  \hline
 \end{tabular} 
\end{center}

\diagrama{vcp_adicionarmembrosp}{\textcolor{red}{VCP para o caso de uso adicionar membros.}}
\diagrama{vcp_criargrupop}{\textcolor{red}{VCP para o caso de uso criar grupo}}
\diagrama{vcp_editareventop}{\textcolor{red}{VCP para o caso de uso editar evento.}}
\diagrama{vcp_excluircategoriap}{\textcolor{red}{VCP para o caso de uso excluir categoria.}}
\diagrama{vcp_excluirgrupop}{\textcolor{red}{VCP para o caso de uso excluir grupo.}}
\diagrama{vcp_participareventop}{\textcolor{red}{VCP para o caso de uso participar evento.}}
\diagrama{vcp_postarp}{\textcolor{red}{VCP para o caso de uso postar.}}
\diagrama{vpc_divulgareventop}{\textcolor{red}{VCP para o caso de uso divulgar evento.}}
